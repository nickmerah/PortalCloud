...
<form method="POST" action="{{ route('updateprofile') }}">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control @error('contact_address') is-invalid @enderror" id="contact_address" rows="3" name="contact_address" required>{{ old('contact_address', $student->contact_address) }}</textarea>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control @error('student_homeaddress') is-invalid @enderror" id="student_homeaddress" rows="3" name="student_homeaddress" required>{{ old('student_homeaddress', $student->student_homeaddress) }}</textarea>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('std_genotype') is-invalid @enderror" id="std_genotype" name="std_genotype" required>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('std_bloodgrp') is-invalid @enderror" id="std_bloodgrp" name="std_bloodgrp" required>
    ...
    <div class="form-group">
        ...
        <input type="email" class="form-control @error('student_email') is-invalid @enderror" id="student_email" name="student_email" value="{{ old('student_email', $student->student_email) }}" required>
        @error('student_email')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="tel" class="form-control @error('student_mobiletel') is-invalid @enderror" name="student_mobiletel" value="{{ old('student_mobiletel', $student->student_mobiletel) }}" required>
    ...
    <div class="form-group">
        ...
        <input type="tel" class="form-control @error('next_of_kin') is-invalid @enderror" name="next_of_kin" value="{{ old('next_of_kin', $student->next_of_kin) }}" required>
        @error('next_of_kin')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="tel" class="form-control @error('nok_tel') is-invalid @enderror" name="nok_tel" value="{{ old('nok_tel', $student->nok_tel) }}" required>
        @error('nok_tel')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control @error('nok_address') is-invalid @enderror" name="nok_address" rows="3" required>{{ old('nok_address', $student->nok_address) }}</textarea>
        @error('nok_address')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="birthdate" value="{{ \Carbon\Carbon::parse($student->birthdate)->format('l, F j, Y') }}" disabled>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="state_of_origin" value="{{ optional($student->stateor)->state_name ?? 'NA' }}" disabled>
    </div>
    <div class="form-group">
        <label for="fullName"><strong>LGA</strong></label>
        <input type="text" class="form-control" id="local_gov" value="{{ optional($student->lga)->lga_name ?? 'NA' }}" disabled>
    </div>
    <div class="form-group">
