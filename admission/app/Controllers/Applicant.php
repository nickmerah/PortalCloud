...
// Special case for HND FT
            if ($progid == 2 && $progtype == 1) {
                $school_share = $total - self::ACCEPTANCE_PORTAL_FEE;

                $postFields["lineItems"] = [
                    [
                        "lineItemsId" => "itemid1",
                        "beneficiaryName" => "DELTA STATE POLYTECHNIC O/UKU",
                        "beneficiaryAccount" => "2004402644",
                        "bankCode" => "011",
                    ...
                    [
                        ...
                        "beneficiaryAccount" => "0072223654",
                        "bankCode" => "232",
                        "beneficiaryAmount" => self::ACCEPTANCE_PORTAL_FEE,
                        "deductFeeFrom" => 0,
                    ]
                ];
            }
