            ...
            <section class="section">
              ...
              <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                  ...
                  <h4 class="page-title m-b-0">Result Verification Fee</h4>
                </li>
                <li class="breadcrumb-item">
    ...
    <form action=\"" . base_url() . "applicant/payresultverify\" method='post'>
        <button type=\"submit\" class=\"btn btn-primary\">
            <i class=\"fas fa-dollar-sign\"></i> Pay again for Result Verification
                    															...
                    															$printbutton = '<select name="vnos" style="width: 200px;"  class="form-control" required>
                                              <option value="">No of Result to Verify</option>
                                               <option value="1">Single</option>
                                                <option value="2">Double</option>
                                            </select> <br> <button type="submit" class="btn btn-success">
        <i class="fas fa-dollar-sign"></i> Pay Result Verification Fee
    </button>
...
<form action="<?php echo base_url('applicant/payresultverify'); ?>" method="POST">
                                 <?= $printbutton; ?> 
                                 </form>
                                 <br>
