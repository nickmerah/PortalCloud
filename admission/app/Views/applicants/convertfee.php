            ...
            <section class="section">
              ...
              <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                  ...
                  <h4 class="page-title m-b-0">Conversion Fee</h4>
                </li>
                <li class="breadcrumb-item">
                                                                      ...
                                                                      <?php foreach($stddetails as $stddetail): ?>
                                                                            ...
                                                                            <div class="mb-3">
                                                                             ...
                                                                             <div class="mb-3">
                    															...
                    															$printbutton = '<a href =  "'.base_url().'/applicant/payconversion" class="btn btn-success"><i class="fas fa-dollar-sign"></i> Pay Conversion Fee </a>';
                    														}
