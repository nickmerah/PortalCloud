  							...
  							<div class="tab-content">
  								 <div class="tab-pane fade show active" id="application" role="tabpanel">
  									...
  									<div class="card">
  									  ...
  									  if ($stddetails[0]->stdprogramme_id == 2 and ($stddetails[0]->std_custome5 == 0 or $stddetails[0]->std_custome6 == 0  ) )  {

  								echo '<script type="text/javascript">
  			alert("Kindly Complete your application process before declaration");
  			window.location = "../applicant/my_application";
  		</script>';  exit;}elseif ($stddetails[0]->stdprogramme_id == 1 and   $stddetails[0]->std_custome6 == 0    )  {
            ...
            foreach($olevels as $olevel){ ?>
  						...
  						<table class="table table-hover my-0" width="100%">
  									...
  									<tbody>
                                          ...
                                          <tr>
  												<td><img alt="Photo" src="<?= base_url('public/certs/'.$stddetails[0]->ndcert);?>"   width="90" height="100" /></td>
