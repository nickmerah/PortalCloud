                         ...
                         <div class="row">
                           <div class="col-md-6">
                             <address>
                               ...
                               <?= $stddetail->app_no; ?> <br>
                               <?= $stddetail->programmet_name; ?> <?= $stddetail->aprogramme_name; ?> <?= $stddetail->stdcourse; ?><br>
                         ...
                         <div class="row mt-4">
                           <div class="col-lg-8">
                             ...
                             <p class="section-lead">The payment method that we provide is to make it easier for you to pay
                               e-invoices.</p>
                             <div class="images">
                               <img src="<?= base_url('assets/img/cards/remita.png');?>" alt="remita">
