            ...
            <section class="section">
              ...
              <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                  ...
                  <h4 class="page-title m-b-0">Acceptance Fee Payments</h4>
                </li>
                <li class="breadcrumb-item">
...
<div id="printableArea">
                    ...
                    <div class="row">
                                                                      ...
                                                                      <?php foreach($stddetails as $stddetail): ?>
                    													<div class="mb-3">
                    															<label class="form-label" for="inputUsername"><strong>UTME No:</strong> </label>
                    															 <?= $stddetail->jambno; ?>
                    														</div>	
																		<div class="mb-3">
											  ...
											  if ($stddetail->std_photo != "") { ?>
                    															<img alt="Photo" src="<?=  $picurl.$stddetail->std_photo;?>" class="rounded-circle img-responsive mt-3" width="135" height="131" />
                    															<?php }else { ?>
