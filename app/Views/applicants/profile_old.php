                     ...
                     <div class="card">
                       ...
                       <div class="card-body">
						 ...
						 ?>
                            ...
                            action="<?=base_url('applicant/update_profile')?>" method="post" enctype="multipart/form-data">
                        											<?= csrf_field()  ?>
...
?>
  ...
  <div class="row">
				    ...
				    echo '<div class="mb-12 col-md-12">
...
<br>
                   <form   name="add_olevel"  action="add_olevel" method="post">
...
<input name="centerno" type="text" class="form-control" id="centerno"   autocomplete = "off" required>    </div>

 <div class="mb-3 col-md-12">
<label class="form-label" for="inputCity"><strong> Examination No</strong></label>
<input name="examno" type="text" class="form-control" id="examno"   autocomplete = "off" required>  </div>
...
<select name="subject[<?=$i ;?>]"   id="subject"  class="form-control" required>
...
<select name="grade[<?=$i ;?>]"   id="grade"  class="form-control" required>
