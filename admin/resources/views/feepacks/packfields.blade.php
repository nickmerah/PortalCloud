                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-signin" method="post" action="{{ route('clearancefees.store') }}" autocomplete="off">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <select name="pack_name" id="epack_name" name="pack_name" class="form-control" required>
                                                            <option value="">Select Pack</option>
                                                            @foreach($packs as $pack)
                                                            <option value="{{ $pack->pack_id }}">{{ $pack->pack_name }}</option>
                                                            @endforeach
                                                        </select>
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('clearancefee', ['type' => 'f', 'id' => $field->field_id]) }}" class="btn btn-info edit">
                                                <i class="material-icons">visibility</i>FeeName
                                            </a>


                                            <a href="{{ route('clearancefee', ['type' => 'p', 'id' => $field->pack_id] ) }}" class="btn btn-secondary edit">
                                                <i class="material-icons">visibility</i>Pack
                                            </a>
                            ...
                            <script type="text/javascript">
                                $(document).on('click', '#fieldEdit', function(e) {
                                    ...
                                    $.ajax({
                                        url: "{{ url('clearancefees') }}/" + field_id,
                                        type: "GET",
                                        data: {
                                            field_id: field_id,
                                            _token: _token
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.done) {
                                                ...
                                                $('#epack_name').val(response.data.pack_id);
                                                $('#editForm').attr('action', "{{ url('clearancefees') }}/" + field_id);
                                            } else {
