            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form class="form-signin" method="post" action="{{ route('updatestudent') }}" autocomplete="off">
                            @csrf
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <select class="form-control" name="stdprogrammetype_id">
                                                        ...
                                                        <option value="{{ $programmeType->programmet_id }}" {{ $student->stdprogrammetype_id == $programmeType->programmet_id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-12 p-t-20 text-center">
                                <button type="submit" class="btn btn-primary waves-effect m-r-15">Update Student Details</button>
