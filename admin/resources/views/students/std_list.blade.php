...
<div class="container mt-5">
    ...
    <div class="mb-3">
        ...
        <button class="btn btn-success me-2" onclick="downloadPassport( {{$prog_id}}, {{$progtype_id}}, {{$level_id}})">
            Download Passports
        </button>
        ...
        @foreach ($std_lists as $std_list)
            <tr>
                ...
                <td>
                    ...
                    @if ($fileExists)
                        <img
                            src="{{ 'https://portal.mydspg.edu.ng/eportal/storage/app/public/passport/' . $std_list->std_photo }}"
                            width="100" height="80">
                    @else
                        <img src="{{ 'https://portal.mydspg.edu.ng/eportal/public/avatar.jpg' }}" width="100"
                             height="80">
                    @endif
