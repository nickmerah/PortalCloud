                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-signin" method="post" action="{{ route('schoolinfo.update', $schoolInfo->skid) }}" autocomplete="off">
                            ...
                            <div><b><u>POSTUTME SETTINGS</u></b></div>
                            <div class="form-group">
                                <div class="form-label-group">
                                    <input type="text" name="nhmarkuee" class="form-control" value="{{ old('nhmarkuee', $schoolInfo->nhmarkuee) }}" required="required">
                                    <label for="inputEmail"><strong>Marquee for PostUTME</strong></label>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="form-label-group">
                                    <input type="text" name="nhendreg_date" class="form-control" value="{{ old('nhendreg_date', $schoolInfo->nhendreg_date) }}" required="required">
                                    <label for="inputEmail"><strong>Registration End Date for PostUTME (<b>MAINTAIN THIS FORMAT</b>)</strong></label>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="form-label-group">
                                    <input type="text" name="nhinterviewdate" class="form-control" value="{{ old('nhinterviewdate', $schoolInfo->nhinterviewdate) }}" required="required">
                                    <label for="inputEmail"><strong>Date for PostUTME </strong> </label>
                                </div>
                            </div>
                            <br>
