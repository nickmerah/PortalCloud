                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item bcrumb-2">
                            <a href="#" onClick="return false;">Levels</a>
                        </li>
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Level<i class="material-icons">add</i> </button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-signin" method="post" action="{{ route('levels.store') }}" autocomplete="off">
                                                @csrf
                                                <label for="email_address1">Level Name</label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="number" class="form-control" placeholder="Enter Level Name" name="level_name" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <select name="programme_id" name="programme_id" class="form-control" required>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="editForm" class="form-signin" method="POST" action="" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="elevel_name" name="level_name" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" class="form-control" id="elevel_id" name="level_id" required="required">
                                                <br>
                            ...
                            <table class="table table-hover js-basic-example contact_list">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>{{ $level->programme->programme_name}}</td>
                                        <td>

                                            <button data-bs-toggle="modal" data-id="{{ $level->level_id }}" id="fieldEdit" class="btn btn-success edit">
                                ...
                                $(document).on('click', '#fieldEdit', function(e) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.done) {
                                                $('#elevel_id').val(response.data.level_id);
                                                $('#elevel_name').val(response.data.level_name);
                                                $('#eprogramme_id').val(response.data.programme_id);
                                                $('#editForm').attr('action', "{{ url('levels') }}/" + level_id);
                                            } else {
