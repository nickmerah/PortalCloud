                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item bcrumb-2">
                            <a href="#" onClick="return false;">Applicants Fee Reports</a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    @endif
                    <div class="body">
                        <h5 align="center">Showing Payment for {{$paymentReport[0]->fee_name}} for {{ $progtype ?? 'FT and PT' }}, {{ $prog ?? 'ND and HND' }}
                        </h5>
