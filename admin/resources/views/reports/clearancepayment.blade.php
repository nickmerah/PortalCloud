                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item bcrumb-2">
                            <a href="#" onClick="return false;">Clearance Fee Payments</a>
                        </li>
                    ...
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover js-basic-example contact_list">
                                ...
                                <tbody>
                                    @foreach ($clearancePaymentReport as $report)
                                    <tr class="odd">
                            ...
                            <a href="{{ route('expclearancefeepayment', array_merge(request()->query(), ['export' => 'excel'])) }}" class="btn btn-primary">Export Report</a>
                        </div>
                    </div>
                </div>
            </div>
