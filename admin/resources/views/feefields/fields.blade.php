                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        <li class="breadcrumb-item">
                            <h4 class="page-title">Applicant Fee</h4>
                        </li>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-signin" method="post" action="{{ route('appfees.store') }}" autocomplete="off">
                                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            &nbsp;
                                            <a href="{{ route('getappfee', ['id' => $field->field_id]) }}" class="btn btn-warning waves-effect">View <i class="material-icons">visibility</i> </a>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.done) {
                                                ...
                                                $('#editForm').attr('action', "{{ url('appfees') }}/" + field_id);
                                            } else {
