...
class ClearancePaymentListExport  implements FromCollection, WithStyles, ShouldAutoSize
{
    protected $data;
    protected $frommonth;
    protected $tomonth;
    ...
    public function collection()
    {
        ...
        $rows->push([]);
        $rows->push(["Clearance List for  $feename  showing from {$this->frommonth->format('M, Y')} to {$this->tomonth->format('M, Y')}"]);
        $rows->push([]);
