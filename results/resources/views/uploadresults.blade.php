          ...
          <form method="POST" enctype="multipart/form-data" action="{{ url('importResult') }}">
            ...
            <div class="dataTable_wrapper">
              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                <thead>
                  <tr>
                    <th colspan="2">Instruction: Browse to select the excel sheet, select a session, level, semester, course of study and import. Excel Files must be in .xls </th>
                  </tr>
                </thead>
                <tbody style="font-size:13px">
                  ...
                  <td><input id="uploadImage" type="file" accept=".xls" name="file" placeholder="Select Excel file" required class="form-control" />
                    File must be saved in .xls extension </br></td>
                  </tr>


                  <tr>
                    <td>&nbsp;</td>
                    <td> <button id="button" type="submit" class="btn btn-success">Upload Excel Sheet </i>
                      </button> </td>
                  </tr>
                </tbody>
              </table>
