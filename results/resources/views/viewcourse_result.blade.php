                ...
                <div class="card">
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr>
                                <th colspan="9"
                                    style="text-align:center; font-size:20px; font-family:Tahoma, Geneva, sans-serif">
                                    <img src="https://portal.mydspg.edu.ng/eportal/public/images/logo.png" width="70"
                                         height="80" alt="Logo" class="responsive-logo"><br> {{ $schoolname }}<br>
