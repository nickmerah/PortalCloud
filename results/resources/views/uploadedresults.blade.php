                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            <a href="{{ route('view.result', [$result->stdcourse_id, $result->level_id, $result->cyearsession, $sem]) }}" class="btn btn-primary btn-sm" target="_blank">View </a>
                                            <a href="{{ route('enterResult', [$result->stdcourse_id, $result->level_id, $result->cyearsession, $sem, $result->cos]) }}" class="btn btn-warning btn-sm" target="_blank">Edit </a>
                                            <a href="{{ route('delete.result', [$result->stdcourse_id, $result->level_id, $result->cyearsession, $sem]) }}"
