...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8"> <br>
            <div class="card">
                <div class="card-header">{{ __('Manual Result Entry') }}</div>
                    ...
                    <form method="POST" action="{{ url('enterResult') }}">
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th colspan="2">Instruction: Browse to select session, level, semester, course of study and enter scores. </th>
                                    </tr>
                                </thead>
                                <tbody style="font-size:13px">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td> <button id="button" type="submit" class="btn btn-success">Enter Scores </i>
                                            </button> </td>
                                    </tr>
                                </tbody>
                            </table>
