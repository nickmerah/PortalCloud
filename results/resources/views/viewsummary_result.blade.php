    ...
    <div class="row justify-content-center">
        <div class="col-md-12"><br>
            <div class="card">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            ...
                            <tr style="font-size:12px;">
                                ...
                                <th><strong>
                                        <div class="text-center" style="line-height: 1;">{!! str_replace(' ', '<br>', 'MATRICULATION NUMBER') !!}
                                        </div>
                                    </strong></th>
                            ...
                            <tr style="font-size:12px;">
                                ...
                                @foreach ($courses as $course)
                                <th><strong>
                                        <div class="text-center" style="line-height: 1;">{!! str_replace(' ', '<br>', $course->courseunit) !!}</div>
                                    </strong></th>
                                @endforeach
                                <th></th>
                                <th></th>
                ...
                <a href="{{ route('resultSummary', [$result->level_id, $session, $semester == 'First Semester' ? 1 : 2, $courseofstudy[0]->do_id, 'print']) }}" class="btn btn-success" target="_blank">
                    View Result Summary
                </a>
